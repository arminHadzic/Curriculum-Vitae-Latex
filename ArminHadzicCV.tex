...
APIs/Libraries & PyTorch, Scikit-Learn, Numpy, Pandas, Keras, Tensorflow, \\ \hline % Content row 2
Operating Systems & Unix/Linux, Windows, Android\\ \hline % Content row 3
Development Environments & Linux Toolchain, Jupyter, Visual Studio, Android Studio, Xilinx\\ %Content row 4
