...
\cvitem{}{Developing unsupervised learning methods to address challenges in open vocabulary segmentation and latent information representation, especially across multiple modalities (e.g., imagery, text, and point clouds). More generally, I am interested in \textbf{deep learning, computer vision, reinforcement learning, NLP, remote sensing} and \textbf{artificial intelligence}.}
