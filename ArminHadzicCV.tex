...
\usepackage[scale=0.87, lmargin=0.95cm, rmargin=0.95cm, footnotesep=1.25cm]{geometry} % Reduce document margins
...
%http://ai.stanford.edu/~garg/files/jobs/garg-cv.pdf
\cvitem{}{Developing methods to integrate a sense of object permanence into computer vision systems using deep learning, reinforcement learning, and cognitive science. Merging traditional machine learning techniques with artificial intelligence in order to address challenges such as visual occlusion and obfuscation.}
