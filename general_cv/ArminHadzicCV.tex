...
\social[googlescholar][scholar.google.com/citations?user=DlDme3IAAAAJ&hl=en]{Papers}
...
\cvitem{}{I am interested in developing unsupervised learning methods to address challenges in \textbf{open vocabulary segmentation} and \textbf{latent representation}, with a focus on multi-modal learning (e.g., imagery, text, and point clouds). My research centers on \textbf{multi-modal fusion}, generative models for \textbf{image synthesis}, and \textbf{localization}. I am particularly interested in how deep learning can drive \textbf{scalable} AI systems that integrate diverse data modalities for advanced machine perception and AI-driven decision making applications.}
...
\begin{itemize} 
	...
	\item Contributed to 9 successful proposals (SBIR, STTR, BAA), securing \textbf{\$6.3M in funding} from IARPA and NGA, driving innovation in advanced AI technologies.
\end{itemize}
}
...
\begin{itemize}
\item CVPR: 2023, 2024, 2025, 2026
\begin{itemize}
	\item Outstanding Reviewer 2024, 2025
\end{itemize}
\item NeurIPS: 2023, 2024, 2025
\item ECCV: 2022, 2024
\item ICCV: 2023
\item ICLR: 2024
