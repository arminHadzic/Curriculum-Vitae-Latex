...
\usepackage[scale=0.9, lmargin=0.95cm, rmargin=0.95cm, footnotesep=1.5cm]{geometry} % Reduce document margins
...
\cvitem{}{Developing \textbf{Deep Learning} methods for simultaneous \textbf{mapping} and \textbf{localization} with integrated \textbf{semantics}. Addressing challenges in visual ambiguity and occlusion from a single vantage point source for \textbf{Computer Vision} systems using a continuous image stream. More generally, I am interested in \textbf{deep learning, machine learning, artificial intelligence,} and \textbf{robotics}.}
...
{
\begin{itemize} 
	\item \textsc{Summary:} Automating the US Road Assessment Program (usRAP) road safety assessment using a deep convolutional neural network to directly estimate roadway safety based on street-level panorama images, reducing evaluation time to milliseconds per image.
