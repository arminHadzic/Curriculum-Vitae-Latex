...
%\address{}
\mobile{(\#\#\#) \#\#\#-\#\#\#\#}
\email{arminhadzic at outlook dot com}
...
\cvitem{}{I am interested in developing unsupervised learning methods to address challenges in \textbf{open vocabulary segmentation} and \textbf{latent information representation}, with a focus on multi-modal learning (e.g., imagery, text, and point clouds). My research centers on \textbf{multi-modal fusion}, \textbf{generative models for image synthesis}, and \textbf{depth estimation}. I am particularly interested in how deep learning can drive \textbf{scalable AI systems} that integrate diverse data modalities for advanced computer vision and AI-driven decision making applications.}
...
{
\begin{itemize} 
	\item Led research efforts in \textbf{multi-modal fusion}~\cite{greenwell2024watch, ProbTraffic}, \textbf{pose estimation}~\cite{ProbTraffic}, \textbf{generative image synthesis}~\cite{Low2High}, and \textbf{depth estimation}, advancing AI-driven models for \textbf{multi-modal learning}, \textbf{contextual representation}, and \textbf{scalable perception systems}.
	\item Developed and implemented \textbf{scalable supervised and unsupervised learning algorithms} for multi-modal data integration and contextual understanding, enabling advanced applications in \textbf{autonomous systems}, \textbf{interactive AI}, and \textbf{real-time simulations}.
...
Programming Languages & Python, C/C++, Verilog, Java, \LaTeX, Assembly, Shell script \\ \hline % Content row 1
Deep Learning Frameworks & PyTorch, Scikit-Learn, Keras, Tensorflow \\ \hline % Content row 2
Operating Systems & Unix/Linux, Windows, OSX, Android \\ \hline % Content row 3
Development Environments \& Tools & Linux Toolchain, Slurm, PyCharm, Visual Studio, Android Studio, Xilinx \\ %Content row 4
...
\begin{itemize}
	\item Outstanding Reviewer 2024
\end{itemize}
\item ECCV: 2022, 2024
\item ICCV: 2023
\item ICLR: 2024
