...
\section{Education}
\cventry{2018-Present}{Master of Science in Computer Science}{University of Kentucky}{\textit{Estimated Graduate Date: Spring 2020}}{\textit{GPA -- 4.0}}{Advised by Associate Professor Nathan Jacobs}
\cventry{2016}{Bachelor of Science in Computer Engineering}{University of Kentucky}{}{\textit{GPA -- 3.8}}{Graduated Magna Cum Laude}
\cventry{2009-2013}{Bachelor of Science in Electrical Engineering}{University of Kentucky}{}{\textit{GPA -- 3.8}}{Graduated Magna Cum Laude, Minor in Computer Science}  % Arguments not required can be left empty
...
\subsection{Research}
\cventry{Lexington, KY}{\textsc{UK Computer Vision Lab}}{Research Assistant}{2018-Present}{}
{
\begin{itemize} 
	\item Advised by Associate Professor Nathan Jacobs.
	\item Designing convolutional neural networks to leverage pointclouds and satellite imagery to regress car freeflow speeds in Kentucky.
...
\cventry{Laurel, MD}{\textsc{Johns Hopkins University Applied Physics Labortory}}{Machine Perception Intern}{2019}{}
{
\begin{itemize} 
...
APIs/Libraries & PyTorch, Scikit-Learn, Numpy, Pandas, Keras, Tensorflow, OSMNX \\ \hline % Content row 2
